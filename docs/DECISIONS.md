...
**Decision:** חמישה לילות במרכז Catania ושני לילות ב־Siracusa / Umbertino. ‏Bellini Holiday House ו־Corte 201 הוזמנו, והבחירה הסופית ביניהן עדיין פתוחה. לצורכי המסלול Bellini נשארת בסיס התכנון; לא מנהלים גרסת ניתוב נפרדת ל־Corte 201.

**Status:** Canonical. ‏Bellini Holiday House היא Confirmed / Booked לתאריכים 26.11–1.12, וגם Corte 201 היא Booked. אף אחת מהן אינה מסומנת עדיין כבחירה הסופית.
...
**Decision:** Catania משמשת בסיס ראשון ומקבלת יום הליכה מלא אך רגוע בשבת ללא רכב, עם מנוחת צהריים ב־Bellini ובונוסים עירוניים קלים אחר הצהריים. Noto היא יעד המעבר הקנוני ב־1.12 במסלול Central Catania → Noto → Cantine Gulino אם תאושר ותשתלב → Siracusa / Umbertino.
...
**Reason:** הבסיס המרכזי מאפשר לחוות את Catania ברגל בשבת ובערבים קלים לאורך השהות, ולכן יום המעבר נשאר רגוע עם 2.5–3.25 שעות ב־Noto כולל צהריים. אם Gulino אינה מתאימה ללוח היום בנוחות, ממשיכים ישירות ל־Siracusa בלי לדחוס את Noto.
